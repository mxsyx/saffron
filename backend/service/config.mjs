...
const STATEMENTS = {
  ...
  'getAllPlAddr': 'SELECT `addr1`,`addr2`,`addr3`,`addr4`,`addr5`,`addr6` FROM `pladdr` WHERE vid=?',
  'getLatest'   : "(SELECT `id`,`name`,`imgaddr`,`actors` FROM `info` WHERE `bigtype`='mv' ORDER BY `id` DESC LIMIT 12) UNION (SELECT `id`,`name`,`imgaddr`,`actors` FROM `info` WHERE `bigtype`='tv' ORDER BY `id` DESC LIMIT 12)",
